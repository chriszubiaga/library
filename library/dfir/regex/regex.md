...
Taken from [AndrewRathbun - DFIRRegex](https://github.com/AndrewRathbun/DFIRRegex/tree/main).
...
| Grab Everything Before the First Comma | `^.[^,]*(?=(\,))` | [Regex101](https://regex101.com/r/e5N4qz/1) |  |
...
| Qakbot C2 | `(http\|https).*\:[0-9]{2,5}\/t5` |  | [Twitter](https://twitter.com/Kostastsale/status/1594902025334321154?t=sGcife-eJnyRfqc8-5hHag&s=19) |
